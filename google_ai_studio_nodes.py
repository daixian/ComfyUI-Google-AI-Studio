...
class GoogleAIStudioImageGenNode:
    ...
    def _build_image_result(self, image_tensor: torch.Tensor) -> Dict[str, Any]:
        """
        Return the IMAGE result together with a preview payload saved to the
        output folder so the frontend can restore the last generated image.
        """
        preview_node = comfy_nodes.SaveImage()
        preview_ui = preview_node.save_images(
            image_tensor,
            filename_prefix="google_ai_studio_preview/GoogleAIStudio",
        )
        return {
            "ui": preview_ui.get("ui", {}),
            "result": (image_tensor,),
        }
            ...
            if model.startswith("gemini"):
                ...
                for part in candidate.content.parts:
                    if part.inline_data is not None:
                        ...
                        return self._build_image_result(image_tensor)
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "GoogleAIStudioTTS": "Google AI Studio TTS / 文本转语音",
    "GoogleAIStudioMultiSpeakerTTS": "Google AI Studio Multi-Speaker TTS / 多说话人文本转语音",
    "GoogleAIStudioTextGen": "Google AI Studio Text Generator / 文本生成",
    "GoogleAIStudioImageGen": "Google AI Studio Image Generator / 图像生成",
}
